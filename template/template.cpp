...
// и записи .wav файлов (read_wav и write_wav). Помимо этого туда скопированы
// файлы AudioFile.h и AudioFile.m из библиотеки для работы с .wav файлами.
...
const char *const INPUT_FILE = "linejka.wav";
...
vector<vector<double> > change_amp(const vector<vector<double> > &channels, double factor) {
